...
<div id="wrapper">
      ...
      <nav>
        <div  class="navigation">
          <ul class="menu">
            ...
            <li><a href="#">我的日记</a>
              <ul>
                <li><a href="<?php echo U('Home/About/about');?>">个人日记</a></li>
  ...
  <div class="container">
    <div class="con_content">
      <div class="about_box" >
        <h2 class="nh1"><span>您现在的位置是：<a href="/" target="_blank">网站首页</a>>><a href="#" target="_blank">留言</a>
        <div class="f_box" style="margin-left:-800px;">
          <p class="a_title">有什么想对我说，请留言给我！</p>
          <p class="p_title"><b>想对我说什么</b></p>
        ...
        <ul class="about_content">
          ...
          <p><img src="/Public/home/images/01.jpg"></p>
          <p>“冥冥中该来则来，无处可逃”。 </p>
        </ul>
        <!--    <div class="nextinfos">
      ...
      <div id="content" style="width: 700px; height: auto;margin-left:100px;margin-top:40px">
	<div class="wrap">
		<div class="comment">
			<div class="head-face">
